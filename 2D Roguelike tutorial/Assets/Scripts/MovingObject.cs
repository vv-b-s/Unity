...
public abstract class MovingObject : MonoBehaviour
{
    ...
    public LayerMask BlockLayer;           //Layer on which collision will be checked.
    ...
    /// Takes x and y directions and RaycastHit2D to check collision.
    /// </summary>
    ...
    {
        //Calculate the remaining distance to move based on the square magnitude (величината) of the difference between current position and end parameter. 
